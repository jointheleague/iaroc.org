...
The primary objective of this competition is to build an "autonomous robot":http://en.wikipedia.org/wiki/Autonomous_robot that can find its way through a set of fixed obstacles, locate an Infra-Red and visible home station beacon and activate a mechanical push-action switch at the home station.
...
Winners for each division will be determined based on points earned by the successful completion of the following tasks
...
|_. Task |_. 1st Place |_. 2nd Place |_. 3rd Place |_. Successful Completion|
| Technical presentation | 200 | 150 | 100 | 50|
| Urban Challenge | 600 | 500 | 400 | 300|
| Urban BONUS |  |  |  | 400|
| Gold Rush Challenge | 200 | 150 | 100 | 50|
...
Order of technical presentation will be based on the reverse ordering achieved on signing up for a test run. That is, the last entry to have a test run time slot, will be the first entry to have to do their Technical Presentation task.
...
We may start the presentations earlier than 13:00 to facilitate a less hectic presentation. We have 11 teams and must be done by 17:00.
