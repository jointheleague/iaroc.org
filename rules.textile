...
In conjunction with the Technical Presentations one lane of the maze will be set aside for a friendly speed test. Each team will race against another team. In case of an odd number of teams one team will race by themselves. There will be only one drag race per team. The time will be recorded for each team. The award of points will go the the 3 teams with the fastest time. A robot must cross the finish line to have its time recorded. The time slot for the race is determined during registration when the Technical Presentation time is selected.

h4(#crowd_pleaser). Crowd Pleaser

During both days of the competition teams will have the opportunity to showcase their robot to the general public. The team will need to spend at least 30 minutes demonstrating and talking to the public to receive points for the showcase. These informal presentations will be conducted at tables located near the doorway to the Science Center. Teams must let a judge know that the team has made their robot available for viewing and procure a judges signature.  Quality of presentation will not be graded but points will be awarded as indicated in the table above. There is no scheduled time for the showcase and teams will schedule themselves at their convenience.
