...
The Mission Briefings may consist of the static display as well as conversational interaction with the team. The focus of the briefing should be on the software program the team has created which is used by the robot. Please see   for more information.
