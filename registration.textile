...
# Mail the completed entry form with team entry fee of $500 to the address below.
...
The iARoC 2014 Flyer is attached below along with a complete set of rules.

Check out iARoC videos and pictures at www.wintrisstech.org.

*Registration Deadline*: The last day for registration is May 1, 2014. Late registrations will be considered on a case-by-case basis and will be charged a late registration fee.

The cost for registration for a team is $500, non-refundable. Any individual or group can enter more than one robot, but a registration fee must accompany each team entry. The same physical robot cannot be entered twice. A team can have copies of the same robot to use as a backup or spare parts or relay running. For first time entrants, discounts are available for iRobot Roomba Creates and Sun Microsystems SPOT controllers.
...
* "2013 iARoC Flyer (pdf)":files/2013%20iARoc_Flyer_Rev2_outlines.pdf
* "2013 Entry Form (pdf)":files/EntryForm2013.pdf
